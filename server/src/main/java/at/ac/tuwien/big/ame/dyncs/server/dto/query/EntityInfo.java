...
import at.ac.tuwien.big.ame.dyncs.server.dto.query.umlmodelspecifics.activitymodelspecifics.ActivityModelEntityInfo;
import at.ac.tuwien.big.ame.dyncs.server.dto.query.umlmodelspecifics.classmodelspecifics.ClassModelEntityInfo;
import at.ac.tuwien.big.ame.dyncs.server.dto.query.umlmodelspecifics.statemachinemodelspecifics.StateMachineModelEntityInfo;
...
public class EntityInfo {
  ...
  public boolean equals(Object o) {
    ...
    if (this.package_ == null) {
      return this.name.equals(that.name) && that.package_ == null;
    }
